...
class MessageHubConfig extends DemoConfig {
  ...
  override def initConfigKeys() {
    config = config ++ Map[String, String](
      ...
      registerConfigKey(CommonClientConfigs.CLIENT_ID_CONFIG, "demo.cognitiveclaims.messagehub"),
      registerConfigKey("auto.offset.reset", "latest"),
      registerConfigKey("acks", "-1"),
      registerConfigKey("retries", "0"),
      registerConfigKey("batch.size", "200"),
      ...
      registerConfigKey(MessageHubConfig.CHECKPOINT_DIR_KEY, "swift://ClaimContainer.spark/ssc"),
  ...
  override protected def registerConfigKey(key: String, default: String = null): (String, String) = {
    kafkaOptionKeys += key
